...
const TeamCoordinatorProfile = () => {
    ...
    const getProfileDetails = async () => {
        try {
            const response = await axiosInstanceForFitSixes.get('teams_by_teamcordinator');
                ...
                <View style={{paddingBottom: 30}}>
                    ...
                    <View style={styles.profileDetailsContent}>
                        ...
                        <View style={styles.profileDetailsSubContent}>
                            ...
                            <View style={styles.inputFieldContent}>
                                <Text style={styles.textView}>Contact Person</Text>
                                <Text
                                    style={styles.inputField}>{profileDetails && profileDetails.team && profileDetails.team.company && profileDetails.team.company.contact_person}</Text>
                            </View>
                        </View>
                        <View style={styles.profileDetailsSubContent}>
                            <View style={styles.iconView}>
                        ...
                        <View style={styles.profileDetailsSubContent}>
                            ...
                            <View style={styles.inputFieldContent}>
                                ...
                                <Text
                                    style={styles.inputField}>{profileDetails && profileDetails.team && profileDetails.team.company && profileDetails.team.gender}</Text>
                            </View>
                        </View>
                        <View style={styles.profileDetailsSubContent}>
                            <View style={styles.iconView}>
                            ...
                            <View style={styles.inputFieldContent}>
                                <Text style={styles.textView}>Location</Text>
                                <Text
                                    style={styles.inputField}>{profileDetails && profileDetails.team && profileDetails.team.company && profileDetails.team.location}</Text>
                            </View>
                        </View>
                        <View style={styles.profileDetailsSubContent}>
                            <View style={styles.iconView}>
...
export default TeamCoordinatorProfile
